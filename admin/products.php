...
if (isset($_POST['Add'])) {
    ...
    $price = $_POST["price"];
    $productObj->addProduct($name, $description, $price, $paths, $images);
    ...
    $productObj->updateProduct($id, $name, $description, $price, $paths, $images, $pathOlds);
} else if (isset($_POST['Remove'])) {
    $id = $_POST["ID"];
    $productObj->removeProduct($id, $pathOlds);
}
?>
<style>
    .modal {
                    ...
                    <div class="col-md-6 pa-5">
                        <div class="panel-heading">
                            <div class=" navbar-btn-right">
                                <a class="btn btn-success" href="#add" data-toggle="modal" name="Set" title="Add Product" onclick="openAdd()" title="Upgrade to Pro"><i class="fa fa-plus"></i> <span>New Product</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        if (count($products) > 0) {
                            ...
                            foreach ($products as $product) {
                                ...
                                echo '<img src=' . $product['Path1'] . ' alt="Avatar" style="width: -webkit-fill-available; height: -webkit-fill-available;">';
                                echo '<h3 class="name">' . $product['name'] . '</h3>';
                                echo '</div>';
                                echo '</div>';
                                echo '<div class="profile-detail">';
                                echo '<div class="profile-info">';
                                echo '<h4 class="heading">' . $product['name'] . '</h4>';
                                echo '<p>' . $product['Description'] . '</p>';
                                echo '   <a  name="Set" data-id="' . $product['id'] . '" data-name="' . $product['name'] . '" data-description="' . $product['description'] . '" data-price="' . $product['price'] .
                                    '" data-path1="' . $product['Path1'] . '" data-path2="' . $product['Path2'] . '" data-path3="' . $product['Path3'] .'" class="modal-trigger" title="show" style="margin-left:auto; " onclick="openEdit()"><i class="fa fa-edit" style="color: black"></i></a>';
                                echo '</div>';
                                echo '</div>';
                                echo '</div>';
                            }
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form method="post" enctype="multipart/form-data" action="products.php">
                            ...
                            <input type="number" class="form-control" placeholder="Price (ETB)" name="price" required><br>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form method="post" enctype="multipart/form-data" action="products.php">
                            ...
                            <label style="font-weight:100"> Product </label> <br>
                            <div>
                            ...
                            <input type="number" id="price" class="form-control" placeholder="Price (ETB)" name="priceUpdate" required><br>
                            <div class="navbar-btn-right">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form method="post" enctype="multipart/form-data" action="products.php">
                            ...
                            Are you sure you want to delete <strong><input type="text" id="ProductTitle" style="border:none; outline:none;" name="ProductTitle"></strong><br>
                            <div class="navbar-btn-right">
                                <button class="btn btn-danger" onclick="closeAdd()">Cancel</button>
